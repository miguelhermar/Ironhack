...
def get_recommendations(title):
    ...
    count_matrix = count.fit_transform(movies_rec['join_features'])
...
movies_list = pickle.load(open('Final-Project/data/movies.pkl', 'rb'))
    
movies_rec = pd.DataFrame(movies_list)

st.image("Final-Project/data/logo_mvdb.png")

st.title('Movie Recommender System')

st.sidebar.image("Final-Project/data/ironhack_logo.png", use_column_width=True)
